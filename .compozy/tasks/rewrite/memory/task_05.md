...
- The current branch still uses `module github.com/user/go-devstack`; new Task 05 code must import `internal/models` through that module path until Task 01 lands.
