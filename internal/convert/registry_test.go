...
func TestNewRegistryRegistersDefaultConvertersInPriorityOrder(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "epub", ext: ".epub", wantType: EPUBConverter{}},
		{name: "image", ext: ".png", wantType: ImageConverter{}},
		...
		{name: "epub by mime", ext: "", mimeType: epubMIMEType, wantType: EPUBConverter{}},
		{name: "image by mime", ext: "", mimeType: "image/png", wantType: ImageConverter{}},
