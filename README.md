...
The link scanner distinguishes ordinary Markdown link labels from wikilinks. In raw imported documents, compact double-bracket mathematical intervals and interpolation expressions are treated as source notation; explicit aliases and managed wiki links are still validated. Original source files are never rewritten by lint.
